...
def banner():
    os.system('clear')
    print " "
    runntxt(GL+"              Kazemwafa hack facbook. ^_^")
    runntxt(WW+"   ..................  Afghanistan MENCOBA MENGHUBUNGI")
    runntxt(WW+"     ....       kazem.wafa")
    ...
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: Kazem.wafa            |"
    print GL+"  |       Berdoa Dulu Sebelum Menggunakan       |"
    print WW+"  |        TEAM : Afghanistan ErRoR SyStEm            |"
    print Y+"  |             INSTAGRAM: pranata_pasha              |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        LIFE OF PROGRAMMER [ L.O.P ]         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
    print GL+"  |•••••••••   HACK FACEBOOK Kazem ^_^   •••••••••|"
    print GG+"  √=============================================√"

banner()

print wd+"         gunakan dengan bijak cok "
print GG+"╭────\033[91m[\033[96m Kazemwafa ID\033[95m / \033[96mUsername Target\033[91m ] "
